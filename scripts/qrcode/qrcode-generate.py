...
if __name__ == '__main__':
    ...
    icon_path = 'luckti.png'
    save_path = './'
    create_qr_code('http://blog.luckticloud.com/posts/2020/09-01-Type-Conversion-and-Casting', icon_path, 'Type-Conversion-and-Casting', save_path)